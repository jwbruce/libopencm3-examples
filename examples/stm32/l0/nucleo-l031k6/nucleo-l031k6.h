...
#ifndef __NUCLEO_L031K6_H
#define __NUCLEO_L031K6_H

/* the STM Nucleo-32 PCB connects the user LED */
/* LD3 to GPIO pin PB13 through the SB15 solder jumper */
/* See the Nucleo-32 schematic and/or users manual*/
#define     LD3_PORT        GPIOB
#define     LD3_PIN         GPIO3
#define     LD3_PORT_RCC    RCC_GPIOB
...
/* the STM Nucleo-32 PCB connects the SERIAL CONSOLE TX */
/* to the alternate function on GPIO pin PA2 */
/* See the Nucleo-32 schematic and/or users manual*/
#define     USART_CONSOLE_TX_PORT         GPIOA
#define     USART_CONSOLE_TX_PIN          GPIO2
#define     USART_CONSOLE_TX_PORT_RCC     RCC_GPIOA
#define     USART_CONSOLE_TX_AF           GPIO_AF4

#endif    // __NUCLEO_L031K6_H
